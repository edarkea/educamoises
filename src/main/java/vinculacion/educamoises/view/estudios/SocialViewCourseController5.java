 ...
 * @author Ana
 */
public class SocialViewCourseController5 extends ViewController implements ActionListener, MouseListener {

    private final SocialViewCourse5 view = new SocialViewCourse5();
    ...
    public SocialViewCourseController5() {
        initEvent();
        recargar();
    }
