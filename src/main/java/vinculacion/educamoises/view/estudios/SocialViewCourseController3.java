...
public class SocialViewCourseController3 extends ViewController implements ActionListener, MouseListener {
    ...
    public void recargar() {
        ...
        view.btnE1.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[0] + ".png")));
        view.btnE2.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[0] + ".png")));
        view.btnE3.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[1] + ".png")));
        view.btnE4.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[1] + ".png")));
        view.btnE5.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[2] + ".png")));
        view.btnE6.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[2] + ".png")));
        view.btnE7.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[3] + ".png")));
        view.btnE8.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[3] + ".png")));
        view.btnE9.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[4] + ".png")));
        view.btnE10.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[4] + ".png")));
        view.btnE11.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[5] + ".png")));
        view.btnE12.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[5] + ".png")));
        view.btnE13.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[6] + ".png")));
        view.btnE14.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[6] + ".png")));
        view.btnE15.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers1[7] + ".png")));
        view.btnE16.setDisabledIcon(new ImageIcon(getClass().getResource("/images/studios/cu" + numbers2[7] + ".png")));
