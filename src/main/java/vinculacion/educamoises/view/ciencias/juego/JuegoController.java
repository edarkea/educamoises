package vinculacion.educamoises.view.ciencias.juego;
...
public class JuegoController extends ViewController implements MouseListener, MouseMotionListener {
    ...
    public void initVariables(String grado) {
        ...
        switch (grado) {
            case "3":
                op1 = "<html><body>Cuarto <br>Creciente<br></body></html>";
                op2 = "<html><body>Luna<br>Nueva<br></body></html>";
                op3 = "Cuarto Menguante";
                op4 = "<html><body>Luna <br>Llena<br></body></html>";
                imagenurl = "imagen3.png";

                break;
            case "5":

                op1 = "<html><body>Neptuno</body></html>";
                op2 = "<html><body>Jupiter</body></html>";
                op3 = "Urano";
                op4 = "<html><body>Saturno</body></html>";
                imagenurl = "imagen5.png";
                break;
            case "7":

                op1 = "<html><body>Zona <br>Fria<br></body></html>";
                op2 = "<html><body>Zonas de la <br>Tierra<br></body></html>";
                op3 = "Zona Templada";
                op4 = "<html><body>Zona <br>Calida<br></body></html>";
    ...
    public void initEvent() {
        ...
        foto = new ImageIcon("src/main/resources/images/ciencias/" + imagenurl);
        if (grado.equals("7")) {
            view.add(pregunta1);
            view.add(pregunta2);
            view.add(pregunta3);
        ...
        view.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e) {
                ...
                switch (grado) {
                    case "3":
                        texto.setText("Arrastre la respuesta correcta a cada Fase Lunar: ");
                        pintarImagen();
                        ubicacion5y7();
                        break;
                    case "5":
                        texto.setText("Teniendo a Mercurio, Venus, Tierra y Marte siga el orden con los siguientes planetas: ");
                        pintarImagen();
                        ubicacion5y7();
                        break;
                    case "7":
                        texto.setText("Arrasrte la respuesta que corresponda a cada zona del planeta: ");
                        pintarImagen();
                        ubicacion5y7();
                        break;
                    default:
