 ...
 * @author Edinson Ayui
 */
public class JuegosMainViewController extends ViewController implements ActionListener, MouseListener {

    private final JuegosViewMain view = new JuegosViewMain();

    public JuegosMainViewController() {
        initEvent();
    }
